...
exports.default = exports.getChainCodeApproveCommand = void 0;
...
function callChainCodeApprove(opt) {
    return __awaiter(this, void 0, void 0, function () {
        var globalConfig, _a, accessId, secret, loginEndpoint, approveEndpoint, token, _b, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    approveEndpoint = "".concat(globalConfig.endpoints.deployment.fabric, "/chaincode/approve");
                    token = { accesstoken: '' };
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
...
function getChainCodeApproveCommand() {
    var chaincodeApprove = new commander_1.default.Command('approve');
    var options = chaincodeApprove.opts();
    chaincodeApprove.option('-n, --network-id <network-id>', 'Id of the Network')
        ...
        if (!options.channel) {
            console.log(chalk_1.default.red('Error: chaincode channel not provided.'));
            return;
        }
        if (!options.sequence) {
        ...
        var status = new Spinner(chalk_1.default.blueBright('Approving, please wait...'));
        status.start();
        callChainCodeApprove(options).then(function (responseMsg) {
            status.stop();
    ...
    return chaincodeApprove;
}
exports.getChainCodeApproveCommand = getChainCodeApproveCommand;
exports.default = getChainCodeApproveCommand;
