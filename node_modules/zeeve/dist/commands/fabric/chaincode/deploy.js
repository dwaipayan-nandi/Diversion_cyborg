...
exports.default = exports.getChainCodeDeployCommand = void 0;
...
function callChainCodeDeploy(opt) {
    return __awaiter(this, void 0, void 0, function () {
        var globalConfig, _a, accessId, secret, loginEndpoint, deployEndpoint, token, _b, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    deployEndpoint = "".concat(globalConfig.endpoints.deployment.fabric, "/chaincode/deploy");
                    token = { accesstoken: '' };
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
...
function getChainCodeDeployCommand() {
    var chaincodeDeploy = new commander_1.default.Command('deploy');
    var options = chaincodeDeploy.opts();
    chaincodeDeploy.option('-n, --network-id <network-id>', 'Id of the Network')
        ...
        var status = new Spinner(chalk_1.default.blueBright('Deploying, please wait...'));
        status.start();
        callChainCodeDeploy(options).then(function (responseMsg) {
            status.stop();
...
exports.getChainCodeDeployCommand = getChainCodeDeployCommand;
exports.default = getChainCodeDeployCommand;
