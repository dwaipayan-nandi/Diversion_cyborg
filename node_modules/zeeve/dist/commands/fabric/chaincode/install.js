...
exports.default = exports.getChainCodeInstallCommand = void 0;
...
function callChainCodeInstall(opt) {
    return __awaiter(this, void 0, void 0, function () {
        var globalConfig, _a, accessId, secret, loginEndpoint, installEndpoint, token, _b, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    installEndpoint = "".concat(globalConfig.endpoints.deployment.fabric, "/chaincode/install");
                    token = { accesstoken: '' };
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
...
function getChainCodeInstallCommand() {
    var chaincodeInstall = new commander_1.default.Command('install');
    var options = chaincodeInstall.opts();
    chaincodeInstall.option('-n, --network-id <network-id>', 'Id of the Network')
        ...
        var status = new Spinner(chalk_1.default.blueBright('Installing, please wait...'));
        status.start();
        callChainCodeInstall(options).then(function (responseMsg) {
            status.stop();
    ...
    return chaincodeInstall;
}
exports.getChainCodeInstallCommand = getChainCodeInstallCommand;
exports.default = getChainCodeInstallCommand;
