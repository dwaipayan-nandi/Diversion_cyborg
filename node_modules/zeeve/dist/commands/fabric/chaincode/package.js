...
exports.default = exports.getChainCodePackageCommand = void 0;
...
var chaincodePackageFilename = 'chaincode.tar.gz';
function callChainCodePackage(opt) {
    return __awaiter(this, void 0, void 0, function () {
        var globalConfig, _a, accessId, secret, loginEndpoint, packageEndpoint, token, _b, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    packageEndpoint = "".concat(globalConfig.endpoints.deployment.fabric, "/chaincode/package");
                    token = { accesstoken: '' };
                    if (fs_1.default.existsSync(opt.filePath)) {
                        console.log("file size : ".concat(fs_1.default.statSync(opt.filePath).size));
                    }
                    else {
                ...
                case 4: return [2 /*return*/, new Promise(function (resolve, reject) {
                        var options = {
                            ...
                            formData: {
                                ...
                                org: opt.org,
                                file: {
                                    value: fs_1.default.createReadStream(opt.filePath),
                                    options: {
                                        filename: chaincodePackageFilename,
                                        contentType: null,
                                    },
                                },
                                ccLanguage: opt.chaincodeLanguage ? opt.chaincodeLanguage : 'golang',
                            },
...
function getChainCodePackageCommand() {
    var chaincodePackage = new commander_1.default.Command('package');
    var options = chaincodePackage.opts();
    chaincodePackage.option('-f, --file-path <file-path>', 'File path for chaincode zip file')
        .option('-n, --network-id <network-id>', 'Id of the Network')
        .option('-c, --chaincode <chaincode>', 'chaincode name')
        .option('-v, --version <version>', 'chaincode version')
        .option('-o, --org <org>', 'chaincode organisation')
        .option('-cl, --chaincode-language <chaincode-language>', ' language for the chaincode, default: golang')
        .action(function () {
        if (!options.filePath) {
        ...
        var status = new Spinner(chalk_1.default.blueBright('Packaging, please wait...'));
        status.start();
        callChainCodePackage(options).then(function (responseMsg) {
            status.stop();
...
exports.getChainCodePackageCommand = getChainCodePackageCommand;
exports.default = getChainCodePackageCommand;
